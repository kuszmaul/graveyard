...
class BenchmarkResult {
 public:
  ...
  void SetMemoryEstimate(size_t memory_size, size_t minimal_memory_estimate) {
    memory_size_ = memory_size;
    minimal_memory_estimate_ = minimal_memory_estimate;
  }
 ...
 private:
  ...
  size_t minimal_memory_estimate_ = 0;  // and estimate of how much memory is
                                        // required (e.g., at 100% load factor).
};
